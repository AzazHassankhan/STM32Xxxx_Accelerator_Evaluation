...
int main(void)
{
  ...
  HAL_CORDIC_Calculate_DMA(&hcordic, pInputSin, pCalculatedSin,360, CORDIC_DMA_DIR_IN_OUT);
  //HAL_Delay(1);
  /* USER CODE END 2 */
  ...
  while (1)
  {
	  outdac= output2[idx] >> 20;
	  HAL_DAC_SetValue(&hdac1,DAC_CHANNEL_1,DAC_ALIGN_12B_R,outdac);
	  idx = (idx+1)%360;
	  HAL_Delay(10);
    /* USER CODE END WHILE */
